...
import { Search, BookOpen, Brain, Shield, Users, Map, Sparkles, ArrowRight, Network } from "lucide-react";
    ...
    <div className="min-h-screen bg-museum-wall flex flex-col">
      ...
      <main className="flex-1 flex flex-col">
        <section className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-16">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto w-full">
            <div
              className="relative p-6 rounded-2xl border-2 border-museum-gold/30 overflow-hidden cursor-pointer group hover:scale-[1.02] transition-all duration-300 animate-fade-up opacity-0"
              style={{
            ...
            >
              <div className="absolute top-3 right-3">
                <Sparkles className="w-5 h-5 text-museum-gold/40 sparkle" />
              </div>

              <div className="flex items-start gap-3">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-museum-gold/30 to-museum-gold/10 border border-museum-gold/50 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="font-display text-lg font-bold text-museum-paper mb-2">
                    关系人格地图
                  </h3>
                  <p className="text-xs text-museum-paper/60 font-body leading-relaxed mb-3">
                    记录你在不同关系中的互动模式，识别高频触发 Bug，
                    输出关系成长趋势。
                  </p>

                  <div className="inline-flex items-center gap-1 text-museum-gold text-sm font-medium">
                    进入探索
            ...
            <div
              className="relative p-6 rounded-2xl border-2 border-purple-400/30 overflow-hidden cursor-pointer group hover:scale-[1.02] transition-all duration-300 animate-fade-up opacity-0"
              style={{
                background: 'linear-gradient(135deg, rgba(167, 139, 250, 0.15) 0%, rgba(26, 58, 58, 0.8) 50%, rgba(236, 72, 153, 0.1) 100%)',
                animationDelay: '0.6s',
              }}
              onClick={() => navigate("/group-dynamics")}
            >
              <div className="absolute top-3 right-3">
                <Sparkles className="w-5 h-5 text-purple-300/40 sparkle" />
              </div>

              <div className="flex items-start gap-3">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/30 to-pink-500/10 border border-purple-400/50 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-museum-paper/60 font-body leading-relaxed mb-3">
                    分析群聊、会议、团队冲突，识别联盟、边缘角色、
                    情绪传染、冲突放大者与缓冲者。
                  </p>

                  <div className="inline-flex items-center gap-1 text-purple-300 text-sm font-medium">
                    进入探索
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </div>
                </div>
              ...
              <span className="corner-decoration corner-decoration-tl" style={{ borderColor: 'rgba(167, 139, 250, 0.3)' }} />
              <span className="corner-decoration corner-decoration-br" style={{ borderColor: 'rgba(167, 139, 250, 0.3)' }} />
            </div>
          </div>
        </section>
      </main>
